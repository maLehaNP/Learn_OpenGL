...
int main() {
	...
	//lightingShader.setVec4("light.vector", -0.2f, -1.0f, -0.3f, 0.0f);  // Light pointing downwards
	lightingShader.setVec4("light.vector", glm::vec4(lightPos, 1.0f));
	...
	// Attenuation (light cover a distance of 50)
	...
	while (!glfwWindowShouldClose(window)) {
		...
		lightingShader.setVec3("light.spotlightPosition", camera.Position);
		lightingShader.setVec3("light.spotlightDirection", camera.Front);
